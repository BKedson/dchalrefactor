...
public class WindowChallengeController : ChallengeController
{
    ...
    {
        return roomStateMachine.GetCurrentState() == FoundryRoomStateMachine.FoundryRoomState.WindowStage;
    }
}
